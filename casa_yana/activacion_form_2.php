        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <?php 
                    ...
                    if(!isset($_GET["pin"])) $_GET["pin"]=$_POST["pin"];
                ?>
                <div class="col-12">
                            ...
                            <div class="col-9">
                                <div class="control-group">
                                    <div class="form-group floating-label-form-group controls mb-0 pb-2">
                                        <label>Tu pin de activación</label>
                                        <input class="form-control" name="pin" type="text" placeholder="PIN" required="required" data-validation-required-message="Please enter your activation PIN." value="<?php if(isset($_GET["pin"])) echo $_GET["pin"];?>">
                                    </div>
                                </div>                                
                                <div class="control-group">
                                    <div class="form-group floating-label-form-group controls mb-0 pb-2">
